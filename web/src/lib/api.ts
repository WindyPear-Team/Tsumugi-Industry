...
export type ProductionEvent = { id: number; work_order_id: number; work_order_step_id?: number; event_type: string; from_status: string; to_status: string; passed_qty: number; failed_qty: number; reason?: string; operator_name: string; created_at: string }
