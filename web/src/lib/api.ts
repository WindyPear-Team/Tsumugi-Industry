...
export type FlowParameter = { name: string; type: "number" | "string" | "boolean" | "device" | "option"; required?: boolean; options?: string[] }
export type FlowFunction = { name: string; code: string; return_type: "none" | "number" | "string" | "boolean"; parameters: FlowParameter[] }
